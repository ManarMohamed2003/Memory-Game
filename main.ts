...
const soundEffects: { backgroundMusic: HTMLAudioElement, flippingSoundEffect: HTMLAudioElement, successSoundEffect: HTMLAudioElement, failSoundEffect: HTMLAudioElement, gameEndedSoundEffect: HTMLAudioElement } = {
...
function checkCardClickability(index: number) {
...
function addFlipClass(card: Card, index: number) {
...
function checkMatch() {
    ...
    if (game.firstCard?.source === game.secondCard?.source) {
...
function clickedCard(card: Card, index: number) {
